...
class LotoPredictor:
    ...
    def train_model(self, data, reference_date=None):
        ...
        # === ✅ ステップ1: evaluation_result.csv から直近のストレート的中データ追加
        try:
        ...
        # === ✅ ステップ2: 自己予測ファイルからの再学習データ追加（スト・ボのみ, 一致数2以上）
        ...
        # === ✅ ステップ3: PPO出力からの再学習データ追加（等級ボックス以上かつ一致数2以上）
        try:
